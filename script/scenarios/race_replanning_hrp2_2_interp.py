...
import pickle
import race_replanning_hrp2_path_2 as tp
...
path0 = pickle.load(open( "race_replanning_hrp2_1_motion_configs", "rb" ))
q_init = path0[7]
...
r.loadObstacleModel ('hpp-rbprm-corba', "race_2", "contact")
fullBody.exportAll(r, configs, 'race_replanning_hrp2_2');
pickle.dump(configs, open( "race_replanning_hrp2_2_motion_configs", "wb" ))
i=0
