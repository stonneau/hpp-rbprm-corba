...
import pickle
import race_replanning_hrp2_path_3 as tp
...
#~ fullBody.addLimb(larmId,larm,lHand,lArmOffset,lArmNormal, lArmx, lArmy, 20000, "manipulability", 0.05)
...
path0 = pickle.load(open( "race_replanning_hrp2_2_motion_configs", "rb" ))
q_init = path0[38]
...
r.loadObstacleModel ('hpp-rbprm-corba', "race_3", "contact")
fullBody.exportAll(r, configs, 'race_replanning_hrp2_4');
pickle.dump(configs, open( "race_replanning_hrp4_3_motion_configs", "wb" ))
i=0
